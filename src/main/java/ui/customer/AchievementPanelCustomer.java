...
public class AchievementPanelCustomer extends DescendantPanel
{
	...
	public AchievementPanelCustomer(GUI gui) 
	{
		super(new GridBagLayout(), gui);
		this.achievements = gui.getDatabaseManager().getCustomerManager().getCurrentCustomer().getAchievements();
		setOpaque(false);
		
		GridBagConstraints gbc = new GridBagConstraints();
		NonOpaqueJLabel fame = new NonOpaqueJLabel("Hall of fame");
		...
		RoundedButton newAchievement = new RoundedButton("New achievement");
		newAchievement.setBackground(GUI.ORANGE);
		newAchievement.setPreferredSize(new Dimension(0,0));
		gbc.gridx = 1;
		gbc.gridy = 0;
		gbc.weightx = 0.3;
		gbc.weighty = 0.1;
        ...
        scrollPane.getViewport().addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) { 
            	...
            	for (Component comp : scrollableOrderPanel.getComponents())
            	{
            		...
            		{
            			comp.setPreferredSize(new Dimension(width - 30, width/4 - 10));
        ...
        newAchievement.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent arg0) {
				MainCustomerPanel parent = (MainCustomerPanel)SwingUtilities.getAncestorOfClass(MainCustomerPanel.class, newAchievement);
				parent.switchPanel(PanelID.NEW_ACHIEVEMENT);
			}
	...
	private class SingularAchievementPanel extends RoundedPanel
	{
		...
		public void displayAchievement()
		{
			...
			achievementDate.setLineWrap(true);
			achievementDate.setWrapStyleWord(true);
			achievementDate.setEditable(false);
			achievementDate.setBackground(reward.getBackground());
			achievementDate.setPreferredSize(new Dimension(0,0));
			gbc = new GridBagConstraints();
			gbc.gridx = 0;
			gbc.gridy = 2;
			gbc.weightx = 0.5;
