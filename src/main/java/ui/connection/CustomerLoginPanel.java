 ...
 */
public class CustomerLoginPanel extends DescendantPanel
{
	private QueryStatus queryStatus;
	
	public CustomerLoginPanel(GUI gui)
	{
		...
		JLabel client = new JLabel("Login as a customer", SwingConstants.CENTER);
        ...
        Runnable onTimeUp = () -> {
			...
			default:
				...
				error.setText("This combination of username and password doesn't match any customer account.");
				break;
			}
        };
	    ...
	    validate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
		    	...
		    	if (gui != null)
		    	{
					...
					queryStatus = gui.getDatabaseManager().loginClientAndRetrieveInfos(customerUsername, customerPassword);
				}
